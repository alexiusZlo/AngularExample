...
import {CardsFreeModule, WavesModule} from 'angular-bootstrap-md';
...
@NgModule({
  declarations: [Task1Component, Task2Component, Task3Component, Task4Component, Task5Component, PageNotFoundComponent, HomeComponent,
    CardUserComponent],
  imports: [
    CommonModule,
